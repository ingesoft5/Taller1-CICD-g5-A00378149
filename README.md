...
2. Capturas de pantalla evidenciando la ejecución de los 4 jobs de CI/CD y el stack corriendo en contenedores.
3. Documento con reflexión técnica de trabajo teniendo en cuenta los fundamentos DevOps, Bitacora de prompts (lista de prompts utilizados), reflexión ética sobre el uso de IAG en esta actividad y en el contexto DevOps.
